...
"./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/style/index.scss"(module, __webpack_exports__, __webpack_require__) {
"use strict";
...
@keyframes rotate {
  ...
  100% {
    -webkit-transform: rotate(360deg);
            transform: rotate(360deg); } }
`, "",{"version":3,"sources":["webpack://./src/style/index.scss"],"names":[],"mappings":"AAAA;EACC,SAAS;EACT,UAAU;EACV,8BAAsB;UAAtB,sBAAsB;EACtB,yBAAiB;KAAjB,sBAAiB;MAAjB,qBAAiB;UAAjB,iBAAiB,EAAA;;AAGlB;EACC,2BAAyB;EACzB,kBAAe;EACf,gBAAgB,EAAA;;AAGjB;EACC,cAAY;EACZ,cAAa;EACb,yBAAyB;EACzB,0BAAwB;EACxB,mBAAiB;EACjB,qBAAmB;EACnB,oBAAa;EAAb,oBAAa;EAAb,aAAa;EACb,4BAAiB;EAAjB,6BAAiB;MAAjB,qBAAiB;UAAjB,iBAAiB;EACjB,yBAAmB;MAAnB,sBAAmB;UAAnB,mBAAmB;EACnB,yBAA6B;MAA7B,6BAA6B,EAAA;EAV9B;IAaE,cAAY;IACZ,eAAa;IACb,2BAAuB;IACvB,kBAAkB,EAAA;IAhBpB;MAoBI,aAAW;MACX,cAAY;MACZ,sBAAsB;MACtB,yBAAyB;MACzB,kBAAkB,EAAA;IAxBtB;MA6BG,aAAW;MACX,cAAY;MACZ,kBAAkB;MAClB,UAAW;MACX,SAAU;MACV,oBAAa;MAAb,oBAAa;MAAb,aAAa;MACb,8BAAmB;MAAnB,6BAAmB;UAAnB,uBAAmB;cAAnB,mBAAmB;MACnB,yBAA8B;UAA9B,sBAA8B;cAA9B,8BAA8B;MAC9B,2BAA4B;UAA5B,4BAA4B;MAC5B,gBAAY,EAAA;MAtCf;QAyCI,cAAU;QACV,eAAW;QACX,uBAAuB;QACvB,gCAAwB;gBAAxB,wBAAwB,EAAA;EA5C5B;IAkDE,WAAY;IACZ,oBAAa;IAAb,oBAAa;IAAb,aAAa;IACb,yBAA8B;QAA9B,sBAA8B;YAA9B,8BAA8B;IAC9B,kBAAe,EAAA;IArDjB;MAuDG,cAAW;MACX,eAAY;MACZ,4CAAoC;cAApC,oCAAoC,EAAA;EAzDvC;IA8DE,cAAY;IACZ,YAAa;IACb,oBAAa;IAAb,oBAAa;IAAb,aAAa;IACb,yBAA8B;QAA9B,sBAA8B;YAA9B,8BAA8B;IAC9B,mBAAiB;IACjB,oBAAkB,EAAA;IAnEpB;MAqEG,aAAY;MACZ,cAAa;MACb,oBAAa;MAAb,oBAAa;MAAb,aAAa;MACb,8BAAmB;MAAnB,6BAAmB;UAAnB,uBAAmB;cAAnB,mBAAmB;MACnB,yBAA8B;UAA9B,sBAA8B;cAA9B,8BAA8B;MAC9B,2BAA4B;UAA5B,4BAA4B;MAC5B,gCAAwB;cAAxB,wBAAwB,EAAA;MA3E3B;QA6EI,sBAAkB;YAAlB,kBAAkB;QAClB,aAAW;QACX,cAAY;QACZ,sBAAsB;QACtB,kBAAkB;QAClB,kBAAkB;QAClB,WAAW;QACX,iCAAyB;gBAAzB,yBAAyB;QACzB,mBAAiB;QACjB,iBAAe;QACf,mBAAmB,EAAA;IAvFvB;MA2FG,oBAAa;MAAb,oBAAa;MAAb,aAAa;MACb,4BAAsB;MAAtB,6BAAsB;UAAtB,0BAAsB;cAAtB,sBAAsB,EAAA;MA5FzB;QA8FI,aAAW;QACX,cAAY;QACZ,sBAAsB;QACtB,kBAAkB;QAClB,kBAAkB;QAClB,WAAW;QACX,mBAAiB;QACjB,kBAAe;QACf,mBAAmB;QACnB,oBAAkB,EAAA;MAvGtB;QA0GI,mBAAgB,EAAA;;AAQpB;EACC;IACC,+BAAuB;YAAvB,uBAAuB,EAAA;EAExB;IACC,iCAAyB;YAAzB,yBAAyB,EAAA,EAAA;;AAL3B;EACC;IACC,+BAAuB;YAAvB,uBAAuB,EAAA;EAExB;IACC,iCAAyB;YAAzB,yBAAyB,EAAA,EAAA","sourcesContent":["* {\n\tmargin: 0;\n\tpadding: 0;\n\tbox-sizing: border-box;\n\tuser-select: none;\n}\n\nbody {\n\tfont: bold 20px \"Courier\";\n\tfont-size: 14px;\n\toverflow: hidden;\n}\n\n#main {\n\twidth: 375px;\n\theight: 630px;\n\tbackground-color: #b7d4a8;\n\tborder: 10px solid black;\n\tmargin: 20px auto;\n\tborder-radius: 40px;\n\tdisplay: flex;\n\tflex-flow: column;\n\talign-items: center;\n\tjustify-content: space-around;\n\n\t#stage {\n\t\twidth: 304px;\n\t\theight: 304px;\n\t\tborder: 2px solid black;\n\t\tposition: relative;\n\n\t\t#snake {\n\t\t\t& > div {\n\t\t\t\twidth: 10px;\n\t\t\t\theight: 10px;\n\t\t\t\tbackground-color: #000;\n\t\t\t\tborder: 1px solid #b7d4a8;\n\t\t\t\tposition: absolute;\n\t\t\t}\n\t\t}\n\n\t\t#food {\n\t\t\twidth: 10px;\n\t\t\theight: 10px;\n\t\t\tposition: absolute;\n\t\t\tleft: 100px;\n\t\t\ttop: 100px;\n\t\t\tdisplay: flex;\n\t\t\tflex-flow: row wrap;\n\t\t\tjustify-content: space-between;\n\t\t\talign-content: space-between;\n\t\t\tpadding: 2px;\n\n\t\t\t& > div {\n\t\t\t\twidth: 3px;\n\t\t\t\theight: 3px;\n\t\t\t\tbackground-color: black;\n\t\t\t\ttransform: rotate(45deg);\n\t\t\t}\n\t\t}\n\t}\n\n\t#score-panel {\n\t\twidth: 300px;\n\t\tdisplay: flex;\n\t\tjustify-content: space-between;\n\t\tfont-size: 14px;\n\t\t.musicIcon{\n\t\t\twidth: 18px;\n\t\t\theight: 18px;\n\t\t\tanimation: rotate 8s infinite linear;\n\t\t}\n\t}\n\n\t#oprate{\n\t\twidth: 304px;\n\t\theight: 200px;\n\t\tdisplay: flex;\n\t\tjustify-content: space-between;\n\t\tpadding-top: 20px;\n\t\tpadding-left: 20px;\n\t\t#dirBox{\n\t\t\twidth: 140px;\n\t\t\theight: 140px;\n\t\t\tdisplay: flex;\n\t\t\tflex-flow: row wrap;\n\t\t\tjustify-content: space-between;\n\t\t\talign-content: space-between;\n\t\t\ttransform: rotate(45deg);\n\t\t\tdiv {\n\t\t\t\ttouch-action: none;\n\t\t\t\twidth: 60px;\n\t\t\t\theight: 60px;\n\t\t\t\tbackground-color: #444;\n\t\t\t\tborder-radius: 50%;\n\t\t\t\ttext-align: center;\n\t\t\t\tcolor: #fff;\n\t\t\t\ttransform: rotate(-45deg);\n\t\t\t\tline-height: 60px;\n\t\t\t\tfont-size: 20px;\n\t\t\t\tfont-weight: normal;\n\t\t\t}\n\t\t}\n\t\t#speedAgin{\n\t\t\tdisplay: flex;\n\t\t\tflex-direction: column;\n\t\t\tdiv {\n\t\t\t\twidth: 60px;\n\t\t\t\theight: 60px;\n\t\t\t\tbackground-color: #666;\n\t\t\t\tborder-radius: 50%;\n\t\t\t\ttext-align: center;\n\t\t\t\tcolor: #fff;\n\t\t\t\tline-height: 60px;\n\t\t\t\tfont-size: 18px;\n\t\t\t\tfont-weight: normal;\n\t\t\t\tmargin-right: 10px;\n\t\t\t}\n\t\t\t#speed{\n\t\t\t\tmargin-top: 15px;\n\t\t\t}\n\t\t\t\n\t\t}\n\t}\n\n}\n\n@keyframes rotate {\n\t0% {\n\t\ttransform: rotate(0deg);\n\t}\n\t100% {\n\t\ttransform: rotate(360deg);\n\t}\n}"],"sourceRoot":""}]);
// Exports
...
"./src/style/index.scss"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
...
/* import */ var _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_index_scss__rspack_import_6 = __webpack_require__("./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/style/index.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__rspack_import_0_default()(_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_index_scss__rspack_import_6["default"], options);




       /* export default */ __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_index_scss__rspack_import_6["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_index_scss__rspack_import_6["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_index_scss__rspack_import_6["default"].locals : undefined);
...
"./node_modules/vconsole/dist/vconsole.min.js"(module, __unused_rspack_exports, __webpack_require__) {
/*!
...
"./src/assets/music.png"(module, __unused_rspack_exports, __webpack_require__) {
"use strict";
module.exports = __webpack_require__.p + "images/music_eaeadcef0f0b9354.png";

},
"./src/assets/stopMusic.png"(module, __unused_rspack_exports, __webpack_require__) {
"use strict";
module.exports = __webpack_require__.p + "images/stopMusic_4cbc234a9168e3df.png";

},
"./src/commponet/config.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  CONTRLSTATE: function() { return CONTRLSTATE; },
  FOODPOSITIONLS: function() { return FOODPOSITIONLS; },
  GETINFO_EVENT: function() { return GETINFO_EVENT; },
  MUSICSTATE: function() { return MUSICSTATE; },
  RECEIVE_INFO_EVENT_MUSIC: function() { return RECEIVE_INFO_EVENT_MUSIC; },
  SCORESTATE: function() { return SCORESTATE; },
  SNAKEPOSITIONLS: function() { return SNAKEPOSITIONLS; }
});
// 用于存档的变量，存在localStorage中
var SNAKEPOSITIONLS = 'SNAKEPOSITION';
var FOODPOSITIONLS = 'FOODPOSITION';
var CONTRLSTATE = 'CONTRLSTATE';
var SCORESTATE = 'SCORESTATE';
var MUSICSTATE = 'MUSICSTATE';
// 自定义事件常量
var GETINFO_EVENT = 'GETINFOEVENT';
var RECEIVE_INFO_EVENT_MUSIC = "RECEIVEINFOEVENTMUSIC";


},
"./src/commponet/contrl.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* import */ var _food__rspack_import_0 = __webpack_require__("./src/commponet/food.ts");
/* import */ var _score__rspack_import_1 = __webpack_require__("./src/commponet/score.ts");
/* import */ var _snake__rspack_import_2 = __webpack_require__("./src/commponet/snake.ts");
/* import */ var _music__rspack_import_3 = __webpack_require__("./src/commponet/music.ts");
/* import */ var _config__rspack_import_4 = __webpack_require__("./src/commponet/config.ts");
...
var Contrl = /*#__PURE__*/ function() {
    "use strict";
    function Contrl() {
        _class_call_check(this, Contrl);
        _define_property(this, "snake", void 0);
        _define_property(this, "score", void 0);
        _define_property(this, "food", void 0);
        _define_property(this, "music", void 0);
        _define_property(this, "isLive", false);
        // 是否暂停游戏
        _define_property(this, "isStop", false);
        // 是否加速
        _define_property(this, "isFast", false);
        _define_property(this, "dirEL", void 0);
        _define_property(this, "speedAginEL", void 0);
        _define_property(this, "liveOptEL", void 0);
        // 初始默认向右走
        _define_property(this, "direction", 'right');
        // 所有控制方向的索引
        _define_property(this, "dirMap", {
            '上': 'up',
            'ArrowUp': 'up',
            'w': 'up',
            '右': 'right',
        ...
        _define_property(this, "isLockDir", false);
        this.snake = new _snake__rspack_import_2["default"]();
        this.score = new _score__rspack_import_1["default"]();
        this.food = new _food__rspack_import_0["default"]();
        this.music = new _music__rspack_import_3["default"]();
        ...
        this.archiveRestore();
        // 监听自定义事件
        document.addEventListener(_config__rspack_import_4.GETINFO_EVENT, this.getInfoHandle.bind(this));
    }
    _create_class(Contrl, [
        {
            // 音乐组件开启声音时需要判断是否暂停状态，暂停状态开启声音也不播放背景音，点击继续才有声音，通过自定义事件传递状态
            key: "getInfoHandle",
            value: function getInfoHandle(e) {
                switch(e.detail){
                    case "isStop":
                        var receveInfoEventMusic = new CustomEvent(_config__rspack_import_4.RECEIVE_INFO_EVENT_MUSIC, {
                            detail: this.isStop
                        });
        ...
        {
            key: "touchHandle",
            value: function touchHandle(e) {
                var _this = this;
                e.preventDefault();
                var target = e.target;
                var inner = target.innerText;
                var isPress = e.type === 'touchstart' || e.type === 'mousedown';
                if (inner === '加速') {
                    this.isFast = isPress;
        ...
        },
        {
            ...
            value: function archive() {
                ...
                this.score.archive();
                this.music.archive();
                localStorage.setItem(_config__rspack_import_4.CONTRLSTATE, JSON.stringify({
                    isArchive: true,
                    dir: this.direction
                }));
            }
        },
        {
            // 点击继续清除存档
            key: "clearArchive",
            value: function clearArchive() {
                localStorage.removeItem(_config__rspack_import_4.CONTRLSTATE);
        ...
        },
        {
            ...
            key: "archiveRestore",
            value: function archiveRestore() {
                try {
                    var archiveData = JSON.parse(localStorage.getItem(_config__rspack_import_4.CONTRLSTATE));
                    if (archiveData === null || archiveData === void 0 ? void 0 : archiveData.isArchive) {
        ...
        },
        {
            ...
            value: function speedTime() {
                ...
                var reduce = (map["".concat(this.score.lever)] || map.fast) * 20;
                var time = (360 - reduce) / (this.isFast ? 2 : 1);
                if (time < 120) {
                    time = 120;
                }
                return time;
        ...
        },
        {
            ...
            value: function start() {
                var changeFood = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
...
/* export default */ __webpack_exports__["default"] = (Contrl);


},
"./src/commponet/food.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* import */ var _u_util__rspack_import_0 = __webpack_require__("./src/util/util.ts");
/* import */ var _config__rspack_import_1 = __webpack_require__("./src/commponet/config.ts");
function _class_call_check(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    }
...
var Food = /*#__PURE__*/ function() {
    "use strict";
    function Food() {
        _class_call_check(this, Food);
        _define_property(this, "foodEl", void 0);
    ...
    _create_class(Food, [
        {
            key: "X",
            get: function get() {
                return _u_util__rspack_import_0.getRealrem(this.foodEl.offsetLeft);
            },
            set: function set(x) {
        ...
        },
        {
            key: "Y",
            get: function get() {
                return _u_util__rspack_import_0.getRealrem(this.foodEl.offsetTop);
            },
            set: function set(y) {
        ...
        },
        {
            ...
            value: function change(postion) {
                ...
                var hasSome = postion === null || postion === void 0 ? void 0 : postion.some(function(item) {
        ...
        },
        {
            ...
            key: "archive",
            value: function archive() {
                localStorage.setItem(_config__rspack_import_1.FOODPOSITIONLS, JSON.stringify({
                    x: this.X,
                    y: this.Y
                }));
            }
        },
        {
            ...
            key: "clearArchive",
            value: function clearArchive() {
                localStorage.removeItem(_config__rspack_import_1.FOODPOSITIONLS);
            }
        },
        {
            // 还原
            key: "archiveRestore",
            value: function archiveRestore() {
                var positionData = JSON.parse(localStorage.getItem(_config__rspack_import_1.FOODPOSITIONLS));
...
/* export default */ __webpack_exports__["default"] = (Food);


},
"./src/commponet/music.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* import */ var _config__rspack_import_0 = __webpack_require__("./src/commponet/config.ts");
function _class_call_check(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
    }
...
var stopIcon = __webpack_require__("./src/assets/stopMusic.png");
var normalIcon = __webpack_require__("./src/assets/music.png");
var Music = /*#__PURE__*/ function() {
    "use strict";
    function Music() {
        _class_call_check(this, Music);
        _define_property(this, "bgMusic", void 0);
        _define_property(this, "playMusic", void 0);
        _define_property(this, "musicImg", void 0);
        _define_property(this, "isMusic", true);
        ...
        document.addEventListener(_config__rspack_import_0.RECEIVE_INFO_EVENT_MUSIC, this.receiveInfoHandle.bind(this));
    }
    _create_class(Music, [
        {
            key: "init",
        ...
        {
            key: "receiveInfoHandle",
            value: function receiveInfoHandle(e) {
        ...
        },
        {
            ...
            value: function setMusic() {
                ...
                this.archive();
                var getInfoEvent = new CustomEvent(_config__rspack_import_0.GETINFO_EVENT, {
                    detail: "isStop"
                });
        ...
        {
            key: "setMusicCom",
            value: function setMusicCom(notPlay) {
                var _this = this;
                if (this.isMusic) {
        ...
        },
        {
            ...
            value: function over() {
                ...
                setTimeout(function() {
                    _this.play('./mp3/over.mp3');
                }, 500);
            }
        },
        {
            key: "setBgMusicSpeed",
            value: function setBgMusicSpeed(speed) {
                if (!this.isMusic) return;
        ...
        },
        {
            ...
            value: function play(src) {
                ...
                this.playMusic.oncanplaythrough = function() {
        ...
        },
        {
            ...
            key: "archive",
            value: function archive() {
                localStorage.setItem(_config__rspack_import_0.MUSICSTATE, String(this.isMusic));
            }
        },
        {
            // 清档
            key: "clearArchive",
            value: function clearArchive() {
                localStorage.removeItem(_config__rspack_import_0.MUSICSTATE);
            }
        },
        {
            // 还原
            key: "archiveRestore",
            value: function archiveRestore() {
                this.isMusic = localStorage.getItem(_config__rspack_import_0.MUSICSTATE) === 'true' ? true : false;
...
/* export default */ __webpack_exports__["default"] = (Music);


},
"./src/commponet/score.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* import */ var _config__rspack_import_0 = __webpack_require__("./src/commponet/config.ts");
function _class_call_check(instance, Constructor) {
...
var Score = /*#__PURE__*/ function() {
    "use strict";
    function Score() {
        var changeLever = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 10, maxLever = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 10;
        _class_call_check(this, Score);
        _define_property(this, "lever", 1); // 等级默认为1
        _define_property(this, "score", 0); // 分数默认为0
        _define_property(this, "maxLever", void 0); // 默认最大等级为10
        _define_property(this, "changeLever", void 0); // 吃多少个升级
        _define_property(this, "scoreEl", void 0);
        _define_property(this, "levelEl", void 0);
    ...
    _create_class(Score, [
        ...
        },
        {
            ...
            key: "archive",
            value: function archive() {
                localStorage.setItem(_config__rspack_import_0.SCORESTATE, JSON.stringify({
                    score: this.score,
                    lever: this.lever
                }));
            }
        },
        {
            ...
            key: "clearArchive",
            value: function clearArchive() {
                localStorage.removeItem(_config__rspack_import_0.SCORESTATE);
            }
        },
        {
            // 还原
            key: "archiveRestore",
            value: function archiveRestore() {
                var scoreData = JSON.parse(localStorage.getItem(_config__rspack_import_0.SCORESTATE));
...
/* export default */ __webpack_exports__["default"] = (Score);


},
"./src/commponet/snake.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
/* import */ var _u_util__rspack_import_0 = __webpack_require__("./src/util/util.ts");
/* import */ var _config__rspack_import_1 = __webpack_require__("./src/commponet/config.ts");
...
var Snake = /*#__PURE__*/ function() {
    "use strict";
    function Snake() {
        _class_call_check(this, Snake);
        _define_property(this, "snakeA", void 0);
        _define_property(this, "headEl", void 0);
        _define_property(this, "snakeAPositin", void 0);
        _define_property(this, "oldPostion", void 0);
    ...
    _create_class(Snake, [
        {
            key: "X",
            get: function get() {
                return _u_util__rspack_import_0.getRealrem(this.headEl.offsetLeft);
            },
            set: function set(x) {
                if (x === this.X) return;
                if (x >= 3 || x < 0) {
        ...
        },
        {
            key: "Y",
            get: function get() {
                return _u_util__rspack_import_0.getRealrem(this.headEl.offsetTop);
            },
            set: function set(y) {
                if (y === this.Y) return;
                if (y >= 3 || y < 0) {
        ...
        },
        {
            ...
            value: function archive() {
                ...
                ].concat(_to_consumable_array(this.snakeAPositin));
                localStorage.setItem(_config__rspack_import_1.SNAKEPOSITIONLS, JSON.stringify(position));
            }
        },
        {
            // 当用户点击继续或者读取存档后，清空存档
            key: "clearArchive",
            value: function clearArchive() {
                localStorage.removeItem(_config__rspack_import_1.SNAKEPOSITIONLS);
            }
        },
        {
            // 存档还原
            ...
            value: function archiveRestore() {
                var _this = this;
                var positionData = JSON.parse(localStorage.getItem(_config__rspack_import_1.SNAKEPOSITIONLS)).reverse();
                var head = positionData.pop();
                this.X = head.x;
                this.Y = head.y;
        ...
        {
            key: "addBody",
            value: function addBody(position) {
                var div = document.createElement('div');
                if (position) {
                    div.style.left = "".concat(position.x, "rem");
                    div.style.top = "".concat(position.y, "rem");
                }
        ...
        },
        {
            ...
            value: function moveBody() {
                ...
                for(var i = this.snakeA.length - 1; i > 0; i--){
                    var oldx = _u_util__rspack_import_0.getRealrem(this.snakeA[i].offsetLeft);
                    var oldy = _u_util__rspack_import_0.getRealrem(this.snakeA[i].offsetTop);
                    var x = _u_util__rspack_import_0.getRealrem(this.snakeA[i - 1].offsetLeft);
                    var y = _u_util__rspack_import_0.getRealrem(this.snakeA[i - 1].offsetTop);
                    this.snakeA[i].style.left = "".concat(x, "rem");
                    this.snakeA[i].style.top = "".concat(y, "rem");
                    temOldPostion.push({
                        x: oldx,
                        y: oldy
                    });
        ...
        },
        {
            ...
            value: function init() {
                var _this = this;
                this.snakeA.forEach(function(item, index) {
                    if (index === 0) {
                        _this.headEl.style.left = '0rem';
                        _this.headEl.style.top = '0rem';
                    } else {
        ...
        },
        {
            // 判断是否撞到自己
            key: "isHitSelf",
            value: function isHitSelf(x, y) {
                var _this = this;
                this.snakeAPositin.forEach(function(item) {
        ...
        },
        {
            ...
            value: function backOne() {
                for(var i = this.snakeA.length - 1; i > 0; i--){
                    var item = this.oldPostion[i];
                    this.snakeA[i].style.left = "".concat(item.x, "rem");
                    this.snakeA[i].style.top = "".concat(item.y, "rem");
                }
            }
        }
    ]);
...
/* export default */ __webpack_exports__["default"] = (Snake);


},
"./src/lib/remFlex.ts"(__unused_rspack_module, exports) {
// --------------------------------------------------
// meta标签
...
"./src/util/util.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  getRealrem: function() { return getRealrem; },
  pxToRem: function() { return pxToRem; },
  realSize: function() { return realSize; },
  remTopx: function() { return remTopx; }
});
/* import */ var _utils__rspack_import_0 = __webpack_require__("../../utils/index.js");
/* import */ var _utils__rspack_import_0_default = /*#__PURE__*/__webpack_require__.n(_utils__rspack_import_0);
...
var pxToRem = function pxToRem(px) {
    return (0,_utils__rspack_import_0.pxToRem)(px);
};
// 根元素100px情况下，rem转化为px
var remTopx = function remTopx(rem) {
    return (0,_utils__rspack_import_0.remToPx)(rem);
};
// 获取相对于根元素100的尺寸
var realSize = function realSize(originSize) {
    return (0,_utils__rspack_import_0.realSize)(originSize);
};
// 将获取到的蛇、食物的位置转化为rem
// 因为使用rem布局，获取的尺寸会有些许误差，蛇运行到右侧或者底部误差会变大，需要转化为对应的rem计算
// 宽度300px转化为3rem，蛇每次移动10px为0.1rem，故转化为的rem需要为0.1的整倍数
var getRealrem = function getRealrem(px) {
    return (0,_utils__rspack_import_0.getRealRem)(px);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* import */ var _style_index_scss__rspack_import_0 = __webpack_require__("./src/style/index.scss");
/* import */ var _lib_remFlex__rspack_import_1 = __webpack_require__("./src/lib/remFlex.ts");
/* import */ var _lib_remFlex__rspack_import_1_default = /*#__PURE__*/__webpack_require__.n(_lib_remFlex__rspack_import_1);
/* import */ var vconsole__rspack_import_3 = __webpack_require__("./node_modules/vconsole/dist/vconsole.min.js");
/* import */ var vconsole__rspack_import_3_default = /*#__PURE__*/__webpack_require__.n(vconsole__rspack_import_3);
/* import */ var _commponet_contrl__rspack_import_2 = __webpack_require__("./src/commponet/contrl.ts");




new _commponet_contrl__rspack_import_2["default"]();
if (true) {
    new (vconsole__rspack_import_3_default())();
}
