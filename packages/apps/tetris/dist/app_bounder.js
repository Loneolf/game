...
#main {
  ...
  #main #game-container {
    ...
    #main #game-container #side-panel {
      display: -webkit-box;
      display: -ms-flexbox;
      display: flex;
      -webkit-box-orient: vertical;
      ...
      -webkit-box-align: center;
          -ms-flex-align: center;
              align-items: center;
      gap: 0.1rem; }
      #main #game-container #side-panel #next-label {
        color: #e94560;
        font-size: 0.14rem;
        font-weight: bold; }
      #main #game-container #side-panel #next-piece {
        border: 0.02rem solid #e94560;
  ...
  #main #oprate {
    ...
    #main #oprate #speedAgin {
      ...
      #main #oprate #speedAgin div {
        ...
        -webkit-transition: all 0.1s ease;
        transition: all 0.1s ease; }
        #main #oprate #speedAgin div:active {
          -webkit-transform: scale(0.95);
                  transform: scale(0.95);
...
@keyframes rotate {
  ...
  100% {
    -webkit-transform: rotate(360deg);
            transform: rotate(360deg); } }
`, "",{"version":3,"sources":["webpack://./src/style/index.scss"],"names":[],"mappings":"AAAA;EACC,SAAS;EACT,UAAU;EACV,8BAAsB;UAAtB,sBAAsB;EACtB,yBAAiB;KAAjB,sBAAiB;MAAjB,qBAAiB;UAAjB,iBAAiB,EAAA;;AAGlB;EACC,2BAAyB;EACzB,kBAAe;EACf,gBAAgB;EAChB,yBAAyB,EAAA;;AAG1B;EACC,cAAY;EACZ,cAAa;EACb,yBAAyB;EACzB,4BAA0B;EAC1B,mBAAiB;EACjB,qBAAmB;EACnB,oBAAa;EAAb,oBAAa;EAAb,aAAa;EACb,4BAAiB;EAAjB,6BAAiB;MAAjB,qBAAiB;UAAjB,iBAAiB;EACjB,yBAAmB;MAAnB,sBAAmB;UAAnB,mBAAmB;EACnB,yBAA6B;MAA7B,6BAA6B,EAAA;EAV9B;IAaE,aAAY;IACZ,cAAa;IACb,oBAAa;IAAb,oBAAa;IAAb,aAAa;IACb,yBAA8B;QAA9B,sBAA8B;YAA9B,8BAA8B;IAC9B,wBAAuB;QAAvB,qBAAuB;YAAvB,uBAAuB,EAAA;IAjBzB;MAoBG,oBAAa;MAAb,oBAAa;MAAb,aAAa;MACb,4BAAsB;MAAtB,6BAAsB;UAAtB,0BAAsB;cAAtB,sBAAsB;MACtB,yBAAmB;UAAnB,sBAAmB;cAAnB,mBAAmB;MACnB,WAAS,EAAA;MAvBZ;QA0BI,cAAc;QACd,kBAAe;QACf,iBAAiB,EAAA;MA5BrB;QAgCI,6BAAyB;QACzB,sBAAkB;QAClB,sBAAsB,EAAA;IAlC1B;MAuCG,6BAAyB;MACzB,sBAAkB;MAClB,sBAAsB,EAAA;EAzCzB;IA8CE,aAAY;IACZ,oBAAa;IAAb,oBAAa;IAAb,aAAa;IACb,yBAA8B;QAA9B,sBAA8B;YAA9B,8BAA8B;IAC9B,kBAAe;IACf,cAAc,EAAA;IAlDhB;MAqDG,cAAW;MACX,eAAY;MACZ,4CAAoC;cAApC,oCAAoC,EAAA;EAvDvC;IA4DE,aAAY;IACZ,cAAa;IACb,oBAAa;IAAb,oBAAa;IAAb,aAAa;IACb,yBAA8B;QAA9B,sBAA8B;YAA9B,8BAA8B;IAC9B,yBAAmB;QAAnB,sBAAmB;YAAnB,mBAAmB;IACnB,iBAAe,EAAA;IAjEjB;MAoEG,aAAa;MACb,qCAAqC;MACrC,kCAAkC;MAClC,WAAS,EAAA;MAvEZ;QA0EI,sBAAkB;YAAlB,kBAAkB;QAClB,aAAW;QACX,cAAY;QACZ,yBAAyB;QACzB,qBAAmB;QACnB,kBAAkB;QAClB,WAAW;QACX,mBAAiB;QACjB,iBAAe;QACf,iBAAiB;QACjB,eAAe;QACf,iCAAyB;QAAzB,yBAAyB,EAAA;QArF7B;UAwFK,8BAAsB;kBAAtB,sBAAsB;UACtB,yBAAyB,EAAA;IAzF9B;MA+FG,oBAAa;MAAb,oBAAa;MAAb,aAAa;MACb,4BAAsB;MAAtB,6BAAsB;UAAtB,0BAAsB;cAAtB,sBAAsB;MACtB,WAAS,EAAA;MAjGZ;QAoGI,aAAW;QACX,eAAY;QACZ,yBAAyB;QACzB,qBAAmB;QACnB,kBAAkB;QAClB,cAAc;QACd,oBAAiB;QACjB,kBAAe;QACf,iBAAiB;QACjB,eAAe;QACf,iCAAyB;QAAzB,yBAAyB,EAAA;QA9G7B;UAiHK,8BAAsB;kBAAtB,sBAAsB;UACtB,yBAAyB,EAAA;;AAO9B;EACC;IACC,+BAAuB;YAAvB,uBAAuB,EAAA;EAExB;IACC,iCAAyB;YAAzB,yBAAyB,EAAA,EAAA;;AAL3B;EACC;IACC,+BAAuB;YAAvB,uBAAuB,EAAA;EAExB;IACC,iCAAyB;YAAzB,yBAAyB,EAAA,EAAA","sourcesContent":["* {\n\tmargin: 0;\n\tpadding: 0;\n\tbox-sizing: border-box;\n\tuser-select: none;\n}\n\nbody {\n\tfont: bold 20px \"Courier\";\n\tfont-size: 14px;\n\toverflow: hidden;\n\tbackground-color: #1a1a2e;\n}\n\n#main {\n\twidth: 375px;\n\theight: 630px;\n\tbackground-color: #16213e;\n\tborder: 10px solid #0f3460;\n\tmargin: 20px auto;\n\tborder-radius: 40px;\n\tdisplay: flex;\n\tflex-flow: column;\n\talign-items: center;\n\tjustify-content: space-around;\n\n\t#game-container {\n\t\twidth: 320px;\n\t\theight: 420px;\n\t\tdisplay: flex;\n\t\tjustify-content: space-between;\n\t\talign-items: flex-start;\n\n\t\t#side-panel {\n\t\t\tdisplay: flex;\n\t\t\tflex-direction: column;\n\t\t\talign-items: center;\n\t\t\tgap: 10px;\n\n\t\t\t#next-label {\n\t\t\t\tcolor: #e94560;\n\t\t\t\tfont-size: 14px;\n\t\t\t\tfont-weight: bold;\n\t\t\t}\n\n\t\t\t#next-piece {\n\t\t\t\tborder: 2px solid #e94560;\n\t\t\t\tborder-radius: 8px;\n\t\t\t\tbackground-color: #000;\n\t\t\t}\n\t\t}\n\n\t\t#board {\n\t\t\tborder: 2px solid #e94560;\n\t\t\tborder-radius: 8px;\n\t\t\tbackground-color: #000;\n\t\t}\n\t}\n\n\t#score-panel {\n\t\twidth: 320px;\n\t\tdisplay: flex;\n\t\tjustify-content: space-between;\n\t\tfont-size: 14px;\n\t\tcolor: #e94560;\n\n\t\t.musicIcon{\n\t\t\twidth: 18px;\n\t\t\theight: 18px;\n\t\t\tanimation: rotate 8s infinite linear;\n\t\t}\n\t}\n\n\t#oprate{\n\t\twidth: 320px;\n\t\theight: 120px;\n\t\tdisplay: flex;\n\t\tjustify-content: space-between;\n\t\talign-items: center;\n\t\tpadding: 0 10px;\n\n\t\t#dirBox{\n\t\t\tdisplay: grid;\n\t\t\tgrid-template-columns: repeat(2, 1fr);\n\t\t\tgrid-template-rows: repeat(2, 1fr);\n\t\t\tgap: 10px;\n\n\t\t\tdiv {\n\t\t\t\ttouch-action: none;\n\t\t\t\twidth: 60px;\n\t\t\t\theight: 50px;\n\t\t\t\tbackground-color: #e94560;\n\t\t\t\tborder-radius: 10px;\n\t\t\t\ttext-align: center;\n\t\t\t\tcolor: #fff;\n\t\t\t\tline-height: 50px;\n\t\t\t\tfont-size: 20px;\n\t\t\t\tfont-weight: bold;\n\t\t\t\tcursor: pointer;\n\t\t\t\ttransition: all 0.1s ease;\n\n\t\t\t\t&:active {\n\t\t\t\t\ttransform: scale(0.95);\n\t\t\t\t\tbackground-color: #ff6b6b;\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\n\t\t#speedAgin{\n\t\t\tdisplay: flex;\n\t\t\tflex-direction: column;\n\t\t\tgap: 10px;\n\n\t\t\tdiv {\n\t\t\t\twidth: 80px;\n\t\t\t\theight: 45px;\n\t\t\t\tbackground-color: #0f3460;\n\t\t\t\tborder-radius: 10px;\n\t\t\t\ttext-align: center;\n\t\t\t\tcolor: #e94560;\n\t\t\t\tline-height: 45px;\n\t\t\t\tfont-size: 14px;\n\t\t\t\tfont-weight: bold;\n\t\t\t\tcursor: pointer;\n\t\t\t\ttransition: all 0.1s ease;\n\n\t\t\t\t&:active {\n\t\t\t\t\ttransform: scale(0.95);\n\t\t\t\t\tbackground-color: #1a4a7a;\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t}\n}\n\n@keyframes rotate {\n\t0% {\n\t\ttransform: rotate(0deg);\n\t}\n\t100% {\n\t\ttransform: rotate(360deg);\n\t}\n}\n"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.d(__webpack_exports__, {
  ...
  TETRISLEVEL: function() { return TETRISLEVEL; },
  TETRISLINES: function() { return TETRISLINES; },
  TETRISSCORE: function() { return TETRISSCORE; },
  TETRISSTATE: function() { return TETRISSTATE; }
});
var TETRISSCORE = 'TETRISSCORE';
var TETRISLEVEL = 'TETRISLEVEL';
var TETRISLINES = 'TETRISLINES';
var TETRISSTATE = 'TETRISSTATE';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* import */ var _score__rspack_import_0 = __webpack_require__("./src/commponet/score.ts");
/* import */ var _tetris__rspack_import_1 = __webpack_require__("./src/commponet/tetris.ts");
/* import */ var _music__rspack_import_2 = __webpack_require__("./src/commponet/music.ts");
/* import */ var _config__rspack_import_3 = __webpack_require__("./src/commponet/config.ts");
...
var Contrl = /*#__PURE__*/ function() {
    ...
    function Contrl() {
        ...
        _define_property(this, "tetris", void 0);
        ...
        _define_property(this, "isGameOver", false);
        _define_property(this, "dirEL", null);
        _define_property(this, "liveOptEL", null);
        _define_property(this, "pauseEL", null);
        _define_property(this, "gameLoop", null);
        _define_property(this, "dropInterval", 1000);
        _define_property(this, "lastDropTime", 0);
        this.tetris = new _tetris__rspack_import_1["default"]();
        this.score = new _score__rspack_import_0["default"]();
        this.music = new _music__rspack_import_2["default"]();
        ...
        if (this.liveOptEL) {
            this.liveOptEL.addEventListener('click', function() {
                return _this.start();
            });
        }
        if (this.pauseEL) {
            this.pauseEL.addEventListener('click', function() {
                return _this.togglePause();
            });
        }
        document.addEventListener('keydown', this.keyDownHandle.bind(this));
        this.archiveRestore();
        document.addEventListener(_config__rspack_import_3.GETINFO_EVENT, this.getInfoHandle.bind(this));
        this.tetris.draw();
    }
    _create_class(Contrl, [
        {
            ...
            value: function getInfoHandle(e) {
                switch(e.detail){
                    case "isStop":
                        var receveInfoEventMusic = new CustomEvent(_config__rspack_import_3.RECEIVE_INFO_EVENT_MUSIC, {
                            detail: this.isStop
                        });
        ...
        },
        {
            ...
            value: function update(currentTime) {
                ...
                var deltaTime = currentTime - this.lastDropTime;
                var speed = this.getSpeed();
                if (deltaTime >= speed) {
                    if (!this.tetris.moveDown()) {
                        this.tetris.lockPiece();
                        var linesCleared = this.tetris.clearLines();
                        if (linesCleared > 0) {
        ...
        },
        {
            ...
            value: function getSpeed() {
                ...
                var minSpeed = 100;
                var speed = baseSpeed - (level - 1) * speedDecrease;
        ...
        },
        {
            ...
            value: function archive() {
                ...
                this.score.archive();
                this.music.archive();
                localStorage.setItem(_config__rspack_import_3.TETRISSTATE, JSON.stringify({
                    isArchive: true,
        ...
        },
        {
            ...
            value: function clearArchive() {
                localStorage.removeItem(_config__rspack_import_3.TETRISSTATE);
        ...
        },
        {
            ...
            value: function archiveRestore() {
                try {
                    var archiveData = JSON.parse(localStorage.getItem(_config__rspack_import_3.TETRISSTATE));
                    if ((archiveData === null || archiveData === void 0 ? void 0 : archiveData.isArchive) && !archiveData.isGameOver) {
...
var Music = /*#__PURE__*/ function() {
    ...
    function Music() {
        ...
        _define_property(this, "isPlay", false);
    ...
    _create_class(Music, [
        ...
        },
        {
            ...
            value: function archiveRestore() {
                try {
                    var isPlay = JSON.parse(localStorage.getItem('TETRISMUSIC'));
...
var Score = /*#__PURE__*/ function() {
    ...
    function Score() {
        ...
        _define_property(this, "level", 1);
        _define_property(this, "lines", 0);
        _define_property(this, "scoreEL", null);
        _define_property(this, "levelEL", null);
        _define_property(this, "linesEL", null);
    ...
    _create_class(Score, [
        ...
        },
        {
            ...
            value: function updateUI() {
                if (this.scoreEL) this.scoreEL.innerText = "".concat(this.score);
                if (this.levelEL) this.levelEL.innerText = "".concat(this.level);
                if (this.linesEL) this.linesEL.innerText = "".concat(this.lines);
            }
        },
        {
            key: "archive",
            value: function archive() {
                localStorage.setItem(_config__rspack_import_0.TETRISSCORE, JSON.stringify(this.score));
                localStorage.setItem(_config__rspack_import_0.TETRISLEVEL, JSON.stringify(this.level));
                localStorage.setItem(_config__rspack_import_0.TETRISLINES, JSON.stringify(this.lines));
            }
        },
        {
            key: "archiveRestore",
            value: function archiveRestore() {
                try {
                    var score = JSON.parse(localStorage.getItem(_config__rspack_import_0.TETRISSCORE));
                    var level = JSON.parse(localStorage.getItem(_config__rspack_import_0.TETRISLEVEL));
                    var lines = JSON.parse(localStorage.getItem(_config__rspack_import_0.TETRISLINES));
        ...
        },
        {
            key: "clearArchive",
            value: function clearArchive() {
                localStorage.removeItem(_config__rspack_import_0.TETRISSCORE);
                localStorage.removeItem(_config__rspack_import_0.TETRISLEVEL);
                localStorage.removeItem(_config__rspack_import_0.TETRISLINES);
            }
        }
    ]);
    return Score;
...
"./src/commponet/tetris.ts"(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return Tetris; }
});
...
var Tetris = /*#__PURE__*/ function() {
    "use strict";
    function Tetris() {
        _class_call_check(this, Tetris);
        var _this_canvas, _this_nextCanvas;
        _define_property(this, "board", []);
        _define_property(this, "boardWidth", 10);
        _define_property(this, "boardHeight", 20);
        _define_property(this, "cellSize", 20);
        _define_property(this, "currentPiece", null);
        _define_property(this, "nextPiece", null);
        _define_property(this, "pieceX", 0);
        _define_property(this, "pieceY", 0);
        _define_property(this, "canvas", null);
        _define_property(this, "ctx", null);
        _define_property(this, "nextCanvas", null);
        _define_property(this, "nextCtx", null);
        _define_property(this, "pieceTypes", [
            {
                shape: [
                    [
                        1,
        ...
        this.ctx = ((_this_canvas = this.canvas) === null || _this_canvas === void 0 ? void 0 : _this_canvas.getContext('2d')) || null;
        this.nextCanvas = document.querySelector('#next-piece');
        this.nextCtx = ((_this_nextCanvas = this.nextCanvas) === null || _this_nextCanvas === void 0 ? void 0 : _this_nextCanvas.getContext('2d')) || null;
    }
    _create_class(Tetris, [
        {
            key: "initBoard",
            value: function initBoard() {
                ...
                this.board = Array.from({
                    ...
                    return Array(_this.boardWidth).fill(0);
                });
        ...
        },
        {
            ...
            value: function generatePiece() {
                var type = Math.floor(Math.random() * this.pieceTypes.length) + 1;
                var piece = this.pieceTypes[type - 1];
                return {
                    shape: piece.shape.map(function(row) {
        ...
        },
        {
            ...
            value: function spawnPiece() {
                ...
                this.currentPiece = _object_spread_props(_object_spread({}, this.nextPiece), {
        ...
        {
            key: "checkCollision",
            value: function checkCollision(newX, newY, shape) {
        ...
        },
        {
            ...
            value: function lockPiece() {
                ...
                var _this_currentPiece = this.currentPiece, shape = _this_currentPiece.shape, x = _this_currentPiece.x, y = _this_currentPiece.y, type = _this_currentPiece.type;
                for(var py = 0; py < shape.length; py++){
                    for(var px = 0; px < shape[py].length; px++){
                        if (shape[py][px]) {
                            var boardY = y + py;
                            var boardX = x + px;
        ...
        },
        {
            ...
            value: function moveLeft() {
                ...
                var newX = this.currentPiece.x - 1;
        ...
        },
        {
            ...
            value: function moveDown() {
                if (!this.currentPiece) return false;
                var newY = this.currentPiece.y + 1;
        ...
        },
        {
            ...
            value: function rotate() {
                ...
                try {
                    for(var _iterator = kicks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                        var kick = _step.value;
        ...
        },
        {
            ...
            value: function draw() {
                ...
                if (this.currentPiece) {
                    var _this_currentPiece = this.currentPiece, shape = _this_currentPiece.shape, x1 = _this_currentPiece.x, y1 = _this_currentPiece.y, type = _this_currentPiece.type;
                    for(var py = 0; py < shape.length; py++){
                        for(var px = 0; px < shape[py].length; px++){
                            if (shape[py][px]) {
                                this.drawCell(x1 + px, y1 + py, this.colors[type]);
                            }
                        }
                    }
                }
                ...
                for(var x2 = 0; x2 <= this.boardWidth; x2++){
                    this.ctx.beginPath();
                    this.ctx.moveTo(x2 * this.cellSize, 0);
                    this.ctx.lineTo(x2 * this.cellSize, this.boardHeight * this.cellSize);
                    this.ctx.stroke();
                }
                for(var y2 = 0; y2 <= this.boardHeight; y2++){
                    this.ctx.beginPath();
                    this.ctx.moveTo(0, y2 * this.cellSize);
                    this.ctx.lineTo(this.boardWidth * this.cellSize, y2 * this.cellSize);
                    this.ctx.stroke();
                }
            }
        },
        {
            ...
            value: function drawCell(x, y, color) {
                ...
                this.ctx.fillRect(x * this.cellSize + padding, y * this.cellSize + padding, this.cellSize - padding * 2, this.cellSize - padding * 2);
                this.ctx.fillStyle = 'rgba(255, 255, 255, 0.3)';
                this.ctx.fillRect(x * this.cellSize + padding, y * this.cellSize + padding, this.cellSize - padding * 2, 3);
                this.ctx.fillRect(x * this.cellSize + padding, y * this.cellSize + padding, 3, this.cellSize - padding * 2);
                this.ctx.fillStyle = 'rgba(0, 0, 0, 0.3)';
                this.ctx.fillRect(x * this.cellSize + padding, y * this.cellSize + this.cellSize - padding - 3, this.cellSize - padding * 2, 3);
                this.ctx.fillRect(x * this.cellSize + this.cellSize - padding - 3, y * this.cellSize + padding, 3, this.cellSize - padding * 2);
            }
        },
        {
            key: "drawNextPiece",
            value: function drawNextPiece() {
                ...
                var _this_nextPiece = this.nextPiece, shape = _this_nextPiece.shape, type = _this_nextPiece.type;
                var cellSize = 20;
                var offsetX = (100 - shape[0].length * cellSize) / 2;
                var offsetY = (100 - shape.length * cellSize) / 2;
                for(var y = 0; y < shape.length; y++){
                    for(var x = 0; x < shape[y].length; x++){
                        if (shape[y][x]) {
        ...
        },
        {
            ...
            value: function archiveRestore() {
                try {
                    var data = JSON.parse(localStorage.getItem('TETRISBOARD'));
                    if (data) {
